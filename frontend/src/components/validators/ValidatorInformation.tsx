...
export const ValidatorInformation: FC<IGenericValidators> = (props) => {
  ...
  return (
    <div className="flex w-full flex-col gap-y-2 rounded-2xl border border-indigo-200 bg-[#A5B4FC12] p-4 dark:border-gray-800 dark:bg-gray-900">
      <div className="flex items-center gap-x-4">
        ...
        {numberOfOldValidators > 0 && (
          <div className="flex flex-col gap-y-2">
            <p className="text-sm font-semibold leading-[14px] text-primary dark:text-indigo-500">
        ...
        {/* TODO: set font to inter once fonts pr is in */}
        {numberOfOldValidators === 0 && (
          <div className="text-sm font-semibold text-primary dark:text-indigo-500">
