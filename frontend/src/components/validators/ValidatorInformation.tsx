...
export const ValidatorInformation: FC<IGenericValidators> = (props) => {
  ...
  return (
    <div className="flex min-h-[10vh] w-full items-center justify-between gap-x-4 rounded-xl border border-indigo-200 bg-indigo-50 dark:bg-gray-900 dark:border-indigo-900 p-4">
      <div className="flex items-center gap-x-4">
        <Zap className="h-5 w-5 text-indigo-500 fill-indigo-500" />
        {numberOfOldValidators > 0 && (
          <div className="flex flex-col gap-y-2">
            <div className="text-md text-indigo-700 dark:text-indigo-500">
