...
const meta = {
  title: "Example/Consolidation/Submission/SubmitConsolidationRequests",
  component: SubmitConsolidationRequests,
  parameters: {
...
} satisfies Meta<typeof SubmitConsolidationRequests>;
