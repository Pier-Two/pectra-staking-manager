...
export const MOCK_VALIDATORS: ValidatorDetails[] = [
  ...
  ...Array.from({ length: 15 }, (_, i) => ({
    ...
    balance: BigInt(Math.floor(Math.random() * 10000000000)),
    effectiveBalance: BigInt(Math.floor(Math.random() * 10000000000)),
